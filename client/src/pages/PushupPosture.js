...
const BicepCurlPosture = () => {
  const URL = "https://teachablemachine.withgoogle.com/models/__xLAgrwT/";
  ...
  return (
    <div className="posture-container">
      <div className="posture-header">Pushup</div>
...
export default BicepCurlPosture;
